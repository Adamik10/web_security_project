...
try {
    ...
    $mail->Body    = 'Click <a href="http://104.248.30.208/web_security_project/account-activation.php?user='. $verificationCode .'">here</a> to activate your account.';
    ...
    <body>
        <section>
            <div id="container">
                ...
                <a href="http://104.248.30.208/web_security_project/account-activation.php?user='. $verificationCode .'">Activate account</a>
