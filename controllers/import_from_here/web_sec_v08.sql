...
('5bf566c384f08', '5bed958bb23b9', '5beda0488cbcf', '&lt;script&gt;alert(&quot;Hello! I am an alert box!!&quot;);&lt;/script&gt;', '2018-11-21 15:08:03'),
('5bf567228f06f', '5bed958bb23b9', '5beda0488cbcf', '&amp;lt;script&amp;gt;alert(&quot;Hello! I am an alert box!!&quot;);&amp;lt;/script&amp;gt;', '2018-11-21 15:09:38'),
...
CREATE TABLE `users` (
  ...
  `salt` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `verified` tinyint(1) NOT NULL,
  `user_image_location` varchar(100) DEFAULT NULL,
...
INSERT INTO `users` (`id_users`, `username`, `email`, `password_hash`, `salt`, `verified`, `user_image_location`, `user_image_name`) VALUES
('5bed924353b16', 'Spyro', 'adoantal2@gmail.com', '$2y$12$I5.Vbc.FseP2lydbCARMhec5/t6gseCIGPPjui8fOEYpznVDfDPVm', '476401', 1, NULL, NULL),
('5beda0488cbcf', 'sasenka', 'sasa.labusova@gmail.com', '$2y$12$Cv7X/9eOWNoxJZuV4ts7Feh9jpBI/wZylkgVRComplkyhOCkE/4bK', '172177', 1, 'images/users/5bf5823c1763f.jpg', '5bf5823c1763f'),
('5bf56858bd93f', 'haha''haha''', 'alexandra.labusova@gmail.com', '$2y$12$HIR5iUl0oO1NK.S0HDwot.VBLTI81UU4U4ToJY9SWq3Gh1MVguqg6', '765077', 1, 'images/users/5bf5837293dfb.JPG', '5bf5837293dfb');
...
('5bf56858bd955', '5bf56858bd93f', '5bf56858bd94b'),
...
--
ALTER TABLE `logging_in`
  MODIFY `id_logging_in` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
